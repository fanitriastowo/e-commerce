				...
				<?php foreach ($products_rands as $product_rand): ?>
					...
					<?php if ($product_rand->stok == 0): ?>
						<div class="thumbnail relative-thumbnail">
							<img src='<?php echo !empty($product_rand->filename) ? site_url('images/products/' . $product_rand->filename ): site_url('images/blank.jpg'); ?>' alt='<?php echo $product_rand->name; ?>' class="img-responsive img-thumbnail" style="max-height: 180px">
