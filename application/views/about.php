...
<body>
	...
	<div class="container">
		<div class="col-sm-offset-2"><h3 class="text-center"><strong>Profil Toko Randu Jati</strong></h3> <hr></div>
		...
		<div class="col-sm-10">
			...
			<img class="center-block img-responsive img-thumbnail" src="<?php echo site_url('assets/images/toko.jpg'); ?>" alt="Toko Randu Jati"> <hr>
